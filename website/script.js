...
const translations = {
    en: {
        ...
        'download.size': '6.6 MB each • DMG installer',
        ...
        'download.permissions.desc': 'Grant permissions in System Settings → Privacy & Security:',
        'download.permissions.auto': 'Automation',
        'download.permissions.access': 'Accessibility',
        'download.permissions.warp': 'CmdTrace (for Warp)',
    ...
    ko: {
        ...
        'download.btn.arm': 'Apple Silicon',
        'download.btn.intel': 'Intel Mac',
        'download.size': '각 6.6 MB • DMG 설치파일',
        ...
        'download.permissions.title': 'Resume 기능이 안 되나요?',
        'download.permissions.desc': '시스템 설정 → 개인 정보 보호 및 보안에서 권한을 부여하세요:',
        'download.permissions.auto': '자동화',
        'download.permissions.access': '손쉬운 사용',
        'download.permissions.warp': 'CmdTrace (Warp용)',
